        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Browse and manage research papers in the repository</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-white/20 shadow-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold text-gray-900">
                    {filteredPapers.filter(p => p.status === 'approved').length}
                  </p>
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        <h3 className="text-lg font-semibold text-gray-900 group-hover:text-[#1C4D8D] transition-colors">
                          {paper.title || 'Untitled Research'}
                        </h3>
                        <span className={`px-2 py-1 text-xs font-medium rounded-full border ${getStatusBadge(paper.status).class}`}>
                          {getStatusBadge(paper.status).label}
                        </span>
                      </div>
...
export default StaffBrowseRepository;