...
async function runChecks() {
  const checks = [
    ...
    () => checkTable('editorial_checklists', 'add_editorial_checklist.sql'),
    () => checkColumn('research_papers', 'doi', 'add_submission_doi.sql'),
    () => checkColumn('research_papers', 'citation_key', 'add_submission_doi.sql'),
